...
import { ContentContainer, TitleContainer, ContentSection, HeadingContainer, PortraitContainer, PortraitHelper } from './atoms'
  ...
  return (
    <ContentContainer>
      ...
      <ContentSection bottom={false}>
        ...
        Programming music organically evolved into an exploration on how to create tools to help myself and others. From here I taught myself some basic HTML, CSS & JavaScript and decided I want to pursue a career in web development. Between school and self-learning, I have worked on many awesome projects including a cloud storage application and a hiking application built around the Google Maps JavaScript API & trail data scraped from the Washington Trails Association website. Because I pour my intersectional skills of creativity and technology into what I do, the projects you will see in my portfolio mirror my values.
        </p>
      </ContentSection>
